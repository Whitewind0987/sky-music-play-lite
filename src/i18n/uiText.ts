...
export const uiText = {
  "zh-CN": {
    ...
    library: {
      ...
      deletePlaylist: "删除歌单",
      noPlaylists: "还没有歌单。",
      emptyPlaylistTitle: "请选择或新建歌单",
      emptyPlaylistDescription: "新建歌单后，可以把本地曲谱加入其中。",
      deleteLocalSong: "删除",
  ...
  "en-US": {
    ...
    library: {
      ...
      noSearchResults: "No matching scores found.",
      ...
      emptyPlaylistTitle: "Select or create a playlist",
      emptyPlaylistDescription:
        "Create a playlist, then add local scores to it.",
