...
export const uiText = {
  "zh-CN": {
    ...
    bottomPlayer: {
      ...
      stop: "停止",
      manualStep: "逐音播放",
      manualStepTooltip: "逐音播放：点击按操作速度逐音，按住按曲谱倍速连续播放",
      next: "下一首",
      progress: "进度",
      queue: "队列",
    ...
    logs: {
      ...
      manualPlaybackStarted: "逐音演奏已开始：{songName}。",
      manualPlaybackStopped: "逐音演奏已停止。",
      manualPlaybackFailed: "逐音演奏失败：{error}",
    ...
    settings: {
      ...
      systemTheme: "跟随系统",
      accentColor: "强调色",
      accentColorHex: "HEX 强调色",
      accentColorPicker: "选择强调色",
      ...
      keyboardShortcuts: [
        { key: "Ctrl + Space", label: "暂停 / 继续" },
        { key: "Ctrl + ArrowRight", label: "下一首" },
        { key: "F9", label: "停止" },
      ],
    },
  },
  "en-US": {
      ...
      upgradeToV2: {
        ...
        sustainStyles: {
          conservative: {
            label: "Conservative",
            description:
              "Sustains only clearly longer notes to reduce the number of sustained events.",
          },
          balanced: {
            label: "Balanced",
            description:
          ...
          custom: {
            label: "Custom",
            description: "Adjust the five sustain values manually.",
          },
        },
        activeValuesSummary:
    ...
    bottomPlayer: {
      ...
      manualStates: {
        idle: "Idle",
        starting: "Starting manual playback",
        active: "Manual playback active",
        tail: "Releasing held notes",
        finished: "Manual playback finished",
        error: "Manual playback error",
      },
      outputModes: {
        preview: "Preview",
      ...
      expandVisualization: "Expand performance visualization",
      ...
      manualStepTooltip: "Manual playback: click to step manually, hold to follow score timing",
      next: "Next",
      progress: "Progress",
      queue: "Queue",
    ...
    logs: {
      ...
      manualPlaybackStarted: "Manual note playback started: {songName}.",
      manualPlaybackStopped: "Manual note playback stopped.",
      manualPlaybackFailed: "Manual note playback failed: {error}",
    ...
    settings: {
      ...
      accentColorHex: "HEX accent color",
      accentColorPicker: "Choose accent color",
      ...
      keyboardShortcuts: [
        { key: "Ctrl + Space", label: "Pause / Resume" },
        { key: "Ctrl + ArrowRight", label: "Next" },
        { key: "F9", label: "Stop" },
      ],
    },
  },
